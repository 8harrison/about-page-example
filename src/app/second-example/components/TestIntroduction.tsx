...
export default function Introduction() {
    return (
        <Container
            className="flex flex-col items-center shadow-sm md:flex-row bg-gradient-to-tr from-green-600 to-emerald-100 md:justify-around py-16 pt-28 h-full"
            id="Home"
        >
            <div className="flex flex-col px-6 sm:px-0 font-display justify-between prose md:my-2 md:self-stretch">
                <div className="md:mt-40 md:pl-10">
                    <h1 className="font-bold">Psicólogo Genésio Costa</h1>
